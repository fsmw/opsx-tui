...
Define requirements for observing the OpenSpec workspace directory for live changes, so the TUI can reactively update when files are created, modified, or deleted under `openspec/`.
