...
Provides a sidecar metadata system for OpenSpec changes — priority, tags, favorite, blocked reasons, notes, and visual ordering — stored outside OpenSpec artifacts in the application's data directory.
...
- **THEN** Pydantic SHALL raise a frozen instance error
